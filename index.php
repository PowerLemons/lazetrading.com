...
<head>
	<!-- Meta -->
	<title>Laze Trading</title>
	<link rel="shortcut icon" href="/favicon.ico" type="image/x-icon" />
	<meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<meta content="Laze Trading is a consulting agency for partnering with Chinese manufacturers to sell their products on the Amazon US marketplace" name="description">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-5 col-lg-6 order-md-2">
            ...
            <!-- Image -->
            <img src="https://landkit.goodthemes.co/assets/img/illustrations/illustration-2.png" class="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0" alt="..." data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-12 col-md-7 col-lg-6 order-md-1" data-aos="fade-up">
            ...
            <h1 class="display-3 text-center text-md-left">
              Your Manufacturing<br>deserves to profit like a <span class="text-primary">US Amazon Seller</span>
            </h1>

            <!-- Text -->
            <p class="lead text-center text-md-left text-muted mb-6 mb-lg-8">
              Manufacturers around the world sell on Amazon US to take advantage of huge B2C profit margins. Let's take your international company to the next level.
            </p>

            <!-- Form -->
            <div class="mb-6 mb-md-8 mb-md-0 order-md-1">
              <div class="form-row">
                <div class="col">

                  <!-- Inout -->
                  <input type="email" placeholder="hello@example.com" class="form-control bg-light border-0">

                </div>
                <div class="col-auto">

                  <!-- Submit -->
                  <button class="btn btn-primary" data-toggle="modal" data-target="#modalQuote">
                    Get A Quote Now
                  </button>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-4" data-aos="fade-up">
            ...
            <!-- Heading -->
            <h3>
              Stop relying on your US middleman customers
            </h3>
          ...
          <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="50">
            ...
            <!-- Heading -->
            <h3>
              Succeed with our 7-figure Amazon selling expertise
            </h3>
          ...
          <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <!-- Heading -->
            <h3>
              Earn the humongous profits of an Amazon seller
            </h3>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-between">
          <div class="col-12 col-md-6">
            ...
            <!-- Heading -->
            <h2>
              We make it easy for your company to sell on Amazon like a pro.
            </h2>
   ...
   <!-- STEPS
          ...
          <div class="col-12 col-md-4">
            <div class="row">
              ...
              <div class="col col-md-12 ml-n5 ml-md-0">
                ...
                <!-- Text -->
                <p class="text-muted mb-6 mb-md-0">
                  <a href="./contact">Email us for a personalized quote.</a> We can arrange a conference call with your boss to hash out the details.
                </p>
          ...
          <div class="col-12 col-md-4">
            <div class="row">
              ...
              <div class="col col-md-12 ml-n5 ml-md-0">
                ...
                <!-- Text -->
                <p class="text-muted mb-0">
                  Rake in passive income. Scale your company by releasing more products on Amazon. <b><u>The sky is the limit!</u></b>
                </p>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-between mb-8 mb-md-11">
          <div class="col-12 col-md-6 order-md-2" data-aos="fade-left">
            ...
            <!-- Heading -->
            <h2>
              We have the Amazon expertise<br>
              <span class="text-primary">to make your company succeed</span>.
            </h2>
            ...
            <div class="d-flex">
              ...
              <div class="ml-5">
                ...
                <!-- Heading -->
                <h4 class="mb-1">
                  We get the Amazon essentials right
                </h4>
            ...
            <div class="d-flex">
              ...
              <div class="ml-5">
                ...
                <!-- Heading -->
                <h4 class="mb-1">
                  And we know the secret tactics too
                </h4>
          ...
          <div class="col-12 col-md-6 col-lg-5 order-md-1" data-aos="fade-right">
            ...
            <div class="card shadow-light-lg">
              ...
              <!-- Image -->
              <img src="https://landkit.goodthemes.co/assets/img/photos/photo-2.jpg" alt="..." class="card-img-top">
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <!-- Submit -->
                  <button class="btn btn-block btn-primary lift" data-toggle="modal" data-target="#modalQuote">
                    Get A Quote Now
                  </button>
    ...
    <div class="position-relative mt-12">
      <div class="shape shape-bottom shape-fluid-x svg-shim text-gray-200">
        <svg viewBox="0 0 1880 480" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-7 col-lg-6 order-md-1">
            ...
            <!-- Heading -->
            <h2>
              Do what your company does best. <br>
              <span class="text-primary">Let us handle everything else</span>.
            </h2>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Text -->
            <p class="font-size-lg text-muted mb-5 mb-md-8">
                      ...
                      <div class="card-body">
                        <blockquote class="blockquote text-center mb-0">
                          ...
                          <footer class="blockquote-footer">
                            <span class="h6 text-uppercase">Minh Tran</span>
                          </footer>
                    ...
                    <div class="w-100">
                      ...
                      <div class="card-body">
                        <blockquote class="blockquote text-center mb-0">
                          ...
                          <!-- Footer -->
                          <footer class="blockquote-footer">
                            <span class="h6 text-uppercase">Donald Kim</span>
                          </footer>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Button -->
            <button class="btn btn-success lift" data-toggle="modal" data-target="#modalQuote">
